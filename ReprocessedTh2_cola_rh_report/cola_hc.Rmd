...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 3905))', 'n_signatures \u2265 3905', prefix = 'collect-classes-from-hierarchical-partition')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 3905))', 'n_signatures \u2265 3905', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 3905),
    method = "UMAP", top_value_method = "ATC", top_n = 1200, scale_rows = TRUE)', 'n_signatures \u2265 3905', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 3905))', 'n_signatures \u2265 3905', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 3905))', 'n_signatures \u2265 3905', prefix = 'test-to-known-factors-from-hierarchical-partition')
